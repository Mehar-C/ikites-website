...
const EXPERTS = [
  ...
  { initials: 'BA', name: 'Ben Ashburn', credentials: 'Senior Trainer & Program Manager, Procore Industry Advancement', role: 'Collaborator · iKites', image: '/experts/Ben.png', bio: 'Ben has over 20 years experience in trades, estimating, and construction management. Ben uses his experience in industry and education to contribute to the goal of Procore\'s Industry Advancement Team.' },
